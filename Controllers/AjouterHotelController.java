...
public class AjouterHotelController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        lien = "Profile" + c + ".jpg";
            ...
            NbreDispo.setTextFormatter(new TextFormatter<Integer>(new IntegerStringConverter(), 0, integerFilter));

            nbrChambre.setTextFormatter(new TextFormatter<Integer>(new IntegerStringConverter(), 0, integerFilter));
    
        nbrEtoie.getItems().add("1");
        nbrEtoie.getItems().add("2");
        nbrEtoie.getItems().add("3");
        nbrEtoie.getItems().add("4");
        nbrEtoie.getItems().add("5");
    ...
    private void Ajouter(ActionEvent event) {
        ...
        if( nom.getText().equals("")  || description.getText().equals("") || adresse.getText().equals("")|| nbrChambre.getText().equals("")|| NbreDispo.getText().equals("")|| prix.getText().equals("")){
       ...
       notificationBuilder.show();
        ...
        c.setImage(lien);
        c.setNbreEtoile(Integer.parseInt((String)nbrEtoie.getValue()));
        ...
        cs.AjoutHotel(c);
         ...
         try {
            ...
            root = FXMLLoader.load(getClass().getResource("/Gui/AfficherHotel.fxml"));
