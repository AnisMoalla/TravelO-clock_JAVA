...
public class EmailTemplate {
    ...
    public static String getResetPassword(int token)
    {
        return "<!doctype html>\n" +
                ...
                "                                    font-family:'Rubik',sans-serif;\"> You have requested to reset your password</h1>\n" +
                "                                    <span\n" +
    ...
    public static String getActivationCode(String code)
    {
        return "<!doctype html>\n" +
                ...
                "                                <td style=\"padding:0 35px;\">\n" +
                "                                    <h1 style=\"color:#1e1e2d; font-weight:500; margin:0;font-size:32px;\n" +
                "                                    font-family:'Rubik',sans-serif;\"> Activate Your Account </h1>\n" +
                "                                    <span\n" +
                "                                            style=\"display:inline-block; vertical-align:middle; margin:29px 0 26px;\n" +
                "                                            border-bottom:1px solid #cecece; width:100px;\"></span>\n" +
                "                                    <p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">\n" +
                "                                  \n" +
                "                                        To Activate your account copy this code \n" +
                "                                         \n" + code +
                "                                    </p>\n" +
                "\n" +
                "                                </td>\n" +
