 ...
 */
public class Mail {
    public static String templatEmailReclamation(Facceuil facceuil)
    {
        return "<!doctype html>\n" +
                "<html lang=\"en-US\">\n" +
                "\n" +
                ...
                "                                    font-family:'Rubik',sans-serif;\"> Vous avez voté </h1>\n" +
                "                                    <span\n" +
                ...
                "                                        Bonjour,Mr/Mme "+facceuil.getId_user() +"<br>\n" +
                "                                        Votre Vote sur la maison " +facceuil.getNom() +"<br>\n" +
                "                                        situeé à : "+facceuil.getAdresse()+"<br>\n" +
    ...
    public static String templatEmailReclamation() {
