 ...
 * @author hazar
 */
public class HoteltemController implements Initializable {
    ...
    public HoteltemController(){
    
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/Guis/HotelItem.fxml"));
    ...
    public HBox getBox() {
        ...
        public void setInfo(Hotel string)  {   
