    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tableViewOffre.setOnMouseClicked((javafx.scene.input.MouseEvent event) ->{
            if (event.getClickCount()==2){
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("../Guis/DetailsReservationEvent.fxml"));
        Pane root;
                try {
                    root = loader.load();
...
private void sendMail(String recepient,String messageToSend) {
    ...
    private void actionVoter(ActionEvent event) {
        ...
        tempEvent2.setRate(tempEvent1.getVote()*(tempEvent1.getRate()+(tempEvent2.getRate()/tempEvent2.getVote())));
